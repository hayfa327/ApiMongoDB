...
// REVIEW: No auth/role check — any user can access the admin dashboard by navigating to /admin
    ...
    <section className="adminPage">
      ...
      <div className="cardGrid">
        <div className="card" onClick={() => navigate("/createExhibitions")}>
          ...
          <p>
            Add a new exhibition to the gallery with artwork, dates, and artist
            information
          </p>
        </div>
        ...
        <div className="card" onClick={() => navigate("/addArtist")}>
          ...
          <h3>Add Artist</h3>
          <p>
            Create a new artist account with gallery access and exhibition
            privileges
          </p>
        </div>
        ...
        <div className="card" onClick={() => navigate("/AllExhibitions")}>
          ...
          <p>
            Browse all current and upcoming exhibitions in the gallery
            collection
          </p>
        </div>
      </div>
      ...
      {/* REVIEW: Stats (8, 24, 3) are hardcoded — they should be fetched from the API to reflect real data */}
